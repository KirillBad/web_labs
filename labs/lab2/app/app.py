...
def cookies():
    ...
    response.set_cookie("meme", "hehehe")
    return response
...
def phone():
    ...
    symbols_to_replace = {"+", " ", "(", ")", "-", "."}
    phone_number = "".join(
        [char for char in phone_number if char not in symbols_to_replace]
    )
    ...
    return render_template(
        "phone.html", phone_number=formatted_phone_number, errors=errors
    )
